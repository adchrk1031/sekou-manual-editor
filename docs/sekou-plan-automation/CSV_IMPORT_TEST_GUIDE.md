...
- 200件テスト版: `public/test-data/sekou_csv_test_200.csv`
- 本番反映後は `/csv` 画面内の `200件テストCSVをダウンロード` から直接保存できます。
...
- `public/test-data/sekou_csv_test_200.csv` は、施工計画書と停電案内文の初期化に必要な主要列を一通り含んでいます。
